...
% Input Parameters
T_evap = 273.15;              % Evaporation Temperature (Kelvin)
T_cond = 313.15;              % Condenser Temperature (Kelvin)
eta_isen = 0.80;              % Isentropic Efficiency
Q_capacity = 3517;            % Cooling Capacity (Watts)
superheat_K = 5;              % Degrees of superheat (Kelvin)
dT_subcool = 2;               % Degrees of subcooling (Kelvin)
...
W_comp = h2 - h1;                 
Q_evap_spec = h1 - h4;            
COP = Q_evap_spec / W_comp;       
m_dot = Q_capacity / Q_evap_spec; 
...
title('T-s Diagram (VCRS)', 'FontSize', 14, 'FontWeight', 'bold', 'Color', 'k');
